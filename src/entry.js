...
app.consoler = function(protocol) {
    console.image('' + protocol + '//javascript.mom/dist/WechatIMG2.jpeg');
};
...
app.posts = function() {
    ...
    var data = [{
        date: '2017/01/01',
        title: 'Webpack + React.js 优化（理论篇)',
        url: 'https://github.com/hoosin/hoosin.github.io/issues/3'
    }, {
        date: '2016/12/30',
        title: '我的 2016 年，Hello 2017',
        url: 'https://github.com/hoosin/hoosin.github.io/issues/2'
    }, {
        date: '2015/12/29',
        title: '2015 年终总结',
        url: 'https://github.com/hoosin/hoosin.github.io/issues/3'
    ...
    for (var i = 0; i < data.length; i++) {
        html += '<div>' +
            '' + i + '.  <a href="' + data[i].url + '">' + data[i].title + '</a>' +
